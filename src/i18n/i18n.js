    ...
    resources: {
      'pt-BR': {
        translation: {
          ...
          NEWSLETTER_TITLE: 'Compartilhe a novidade',
          NEWSLETTER_SUBTITLE: 'Quer que seus amigos também ganhem a lista personalizada deles? Preencha agora!',
          INVALID_EMAIL: 'Insira um endereço de email válido.',
          REQUIRED_EMAIL: 'E-mail obrigatório!',
          REQUIRED_NAME: 'Nome obrigatório!',
          SEND_EMAIL: 'Enviar agora',
          PRODUCT_TITLE: 'Sua seleção especial',
        },
      },
    },
    fallbackLng: 'pt-BR',
